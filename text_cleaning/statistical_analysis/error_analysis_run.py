...
mistakes_normalized_letter = error_analysis.cluster_mistakes(
    mistakes_normalized_letter, num_clusters=3, clusters_to_return=2
)
...
mistakes_normalized_space_subtracted = error_analysis.normalize_counts_letter(
    space_subtracted_mistakes, counted_characters
)
